...
(azData, azLabels) = load_az_dataset("E:/MS/OCR-Handwriting-Recognition/a_z_handwritten_data.csv")
...
model.save("E:/MS/OCR-Handwriting-Recognition/handwritingmodel", save_format="h5")
...
plt.savefig("E:/MS/OCR-Handwriting-Recognition/plot.png")
